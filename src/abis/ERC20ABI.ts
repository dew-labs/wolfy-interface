const ERC20ABI = [
  {type: 'impl', name: 'ERC20Impl', interface_name: 'satoru::token::erc20::interface::IERC20'},
  {
    type: 'struct',
  ...
  },
  {
    ...
    kind: 'enum',
    variants: [
      {name: 'Transfer', type: 'satoru::token::erc20::erc20::ERC20::Transfer', kind: 'nested'},
      {name: 'Approval', type: 'satoru::token::erc20::erc20::ERC20::Approval', kind: 'nested'},
    ],
  },
] as const
