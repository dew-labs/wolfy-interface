const DepositHandlerABI = [
    ...
    items: [
      {
        ...
        inputs: [
          ...
          {name: 'params', type: 'satoru::deposit::deposit_utils::CreateDepositParams'},
        ],
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: 'deposit_vault_address', type: 'core::starknet::contract_address::ContractAddress'},
...
export default DepositHandlerABI
