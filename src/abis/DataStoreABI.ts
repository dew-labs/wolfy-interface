const DataStoreABI = [
  {type: 'impl', name: 'DataStore', interface_name: 'satoru::data::data_store::IDataStore'},
  {
    type: 'enum',
    name: 'core::bool',
    variants: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        inputs: [
          {name: 'key', type: 'core::felt252'},
          {name: 'value', type: 'satoru::utils::i256::i256'},
          {name: 'error', type: 'core::felt252'},
        ],
        outputs: [{type: 'core::integer::u256'}],
        state_mutability: 'external',
      },
      ...
      },
      {
        type: 'function',
        name: 'get_market',
        inputs: [{name: 'key', type: 'core::starknet::contract_address::ContractAddress'}],
  ...
  {type: 'event', name: 'satoru::data::data_store::DataStore::Event', kind: 'enum', variants: []},
] as const
export default DataStoreABI
