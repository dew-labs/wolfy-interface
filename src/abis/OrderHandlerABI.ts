const OrderHandlerABI = [
    ...
    items: [
      {
        ...
        inputs: [
          ...
          {name: 'params', type: 'satoru::order::base_order_utils::CreateOrderParams'},
        ],
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: 'order_vault_address', type: 'core::starknet::contract_address::ContractAddress'},
      {name: 'oracle_address', type: 'core::starknet::contract_address::ContractAddress'},
      {name: 'swap_handler_address', type: 'core::starknet::contract_address::ContractAddress'},
      {name: 'referral_storage_address', type: 'core::starknet::contract_address::ContractAddress'},
      {name: 'order_utils_class_hash', type: 'core::starknet::class_hash::ClassHash'},
      {name: 'increase_order_utils_class_hash', type: 'core::starknet::class_hash::ClassHash'},
      {name: 'decrease_order_utils_class_hash', type: 'core::starknet::class_hash::ClassHash'},
      {name: 'swap_order_utils_class_hash', type: 'core::starknet::class_hash::ClassHash'},
    ],
  },
  {
    type: 'event',
...
export default OrderHandlerABI
