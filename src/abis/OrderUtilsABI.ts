const OrderUtilsABI = [
  {type: 'impl', name: 'OrderUtilsImpl', interface_name: 'satoru::order::order_utils::IOrderUtils'},
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'satoru::order::order_utils::IOrderUtils',
    items: [
      {
        type: 'function',
        name: 'create_order_utils',
        inputs: [
          {name: 'data_store', type: 'satoru::data::data_store::IDataStoreDispatcher'},
          {name: 'event_emitter', type: 'satoru::event::event_emitter::IEventEmitterDispatcher'},
          {name: 'order_vault', type: 'satoru::order::order_vault::IOrderVaultDispatcher'},
      ...
      },
      {
        ...
        inputs: [
          ...
          {name: 'reason_bytes', type: 'core::array::Array::<core::felt252>'},
        ],
        outputs: [],
        state_mutability: 'external',
      },
  ...
  },
  {
    ...
    name: 'constructor',
    inputs: [
      {name: 'increase_order_class_hash', type: 'core::starknet::class_hash::ClassHash'},
      {name: 'decrease_order_class_hash', type: 'core::starknet::class_hash::ClassHash'},
      {name: 'swap_order_class_hash', type: 'core::starknet::class_hash::ClassHash'},
    ],
  },
  {
    type: 'event',
    name: 'satoru::order::order_utils::OrderUtils::Event',
    kind: 'enum',
    variants: [],
  },
] as const
export default OrderUtilsABI
