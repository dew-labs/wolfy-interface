const DecreaseOrderUtilsABI = [
  {
    type: 'impl',
    name: 'DecreaseOrderUtilsImpl',
    interface_name: 'satoru::order::decrease_order_utils::IDecreaseOrderUtils',
  },
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'satoru::order::decrease_order_utils::IDecreaseOrderUtils',
    items: [
      {
        type: 'function',
        name: 'process_order',
      ...
      },
      {
        ...
        inputs: [
          ...
          {name: 'position_increased_at_block', type: 'core::integer::u64'},
          {name: 'position_decreased_at_block', type: 'core::integer::u64'},
        ],
        outputs: [],
        state_mutability: 'external',
      },
      ...
      {
        type: 'function',
        name: 'validate_output_amount_secondary',
        inputs: [
          {name: 'oracle', type: 'satoru::oracle::oracle::IOracleDispatcher'},
          {name: 'output_token', type: 'core::starknet::contract_address::ContractAddress'},
          {name: 'output_amount', type: 'core::integer::u256'},
  ...
  {
    type: 'event',
    name: 'satoru::order::decrease_order_utils::DecreaseOrderUtils::Event',
    kind: 'enum',
    variants: [],
  },
] as const
export default DecreaseOrderUtilsABI
