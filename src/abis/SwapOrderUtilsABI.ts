const SwapOrderUtilsABI = [
  {
    type: 'impl',
    name: 'SwapOrderUtilsImpl',
    interface_name: 'satoru::order::swap_order_utils::ISwapOrderUtils',
  },
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'satoru::order::swap_order_utils::ISwapOrderUtils',
    items: [
      {
        type: 'function',
        name: 'process_order',
  ...
  {
    type: 'event',
    name: 'satoru::order::swap_order_utils::SwapOrderUtils::Event',
    kind: 'enum',
    variants: [],
  },
] as const
export default SwapOrderUtilsABI
