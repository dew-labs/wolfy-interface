  ...
  return Promise.resolve(
    new Map<string, Price>([
      [
        ...
        {min: 3699531877496039000000n, max: 3701098600000000000000n},
      ], // zETH
      [
        '0x06f20e6aec861fbfe738dc9b639832ff449a5ce762cbcfbe84132561cab49e54',
        {min: 999900000000000000n, max: 1000062000000000000n},
      ], // USDC
      [
        '0x06c91e45243196580079bb9287555b4c3abe453fc54b98176c8cda9758b29504',
        {min: 1500062000000000000n, max: 1600062000000000000n},
      ], // GM zETH/USDC
      [
      ...
      [
        ...
        {min: 1600062000000000000n, max: 1700062000000000000n},
      ], // GM wETH/USDc
    ]),
  )
}
