...
You will be given a high-level overview of the feature/task/problem or an objective, an explanation of what the user wants to achieve/the goal, and maybe suggesting a solution, hints, etc.
